    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="contact.php"><i class="fa fa-fw fa-envelope"></i> Contact Us</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="flex-container">
                ...
                <div class="flex-child magenta">
                    ...
                    <p>If you have any questions, just feel free to contact us and we will answer you. If you are living nearby, come visit TaxExpert at one of our comfortable officers.</p>
                </div>
                <div class="flex-child magenta">
                    <h1>Get in Touch</h1>
                    <p><b>Phone no:</b> 020 8743 8000<br><b>Alternate:</b> 03700 100 222 <br><b>Address:</b> BBC London, 2nd Floor, Peel Wing, BBC Broadcasting House, Portland Place, London, W1A 1AA
                    </p>
                </div>
            
        </div>
</div>
      <br>  <h2>follow us on &nbsp;&nbsp; &nbsp;&nbsp; <a href="https://www.instagram.com/bbcnews/?hl=en" class="fa fa-instagram" style="color: red;"></a> &nbsp;&nbsp; &nbsp;&nbsp; 
        <a href="https://www.facebook.com/bbcnews/" class="fa fa-facebook" style="color: red;"></a>&nbsp;&nbsp; &nbsp;&nbsp;
        <a href="https://twitter.com/BBCWorld?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" class="fa fa-twitter" style="color: red;"></a></h2> 
